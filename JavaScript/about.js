...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // If nothing exists yet, default to martiniqueSeaPink theme (inverted default)
  let blueOrMartinique =
    sessionStorage.getItem("blueOrMartinique") || "#2E3049";
  let brownOrSeakPink = sessionStorage.getItem("brownOrSeaPink") || "#EE9391";
  let lightBrownOrSeaPink =
    sessionStorage.getItem("lightBrownOrSeaPink") || "#EE9391";
  let brownOrMartinique =
    sessionStorage.getItem("brownOrMartinique") || "#2E3049";
  let desertSandOrSeaPink =
    sessionStorage.getItem("desertSandOrSeaPink") || "#EE9391";
